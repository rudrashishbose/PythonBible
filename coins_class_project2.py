...
class Two_Pence(Coin):
    ...
    def rust(self):  # overidden function
        self.color = self.clean_color
        
    def clean(self): # overidden function
        self.color =self.clean_color
...
for coin in coins:
    ...
    string = string = "{} - Color: {}, value:{}, diameter(mm):{}, thickness(mm):{}, number of edges:{}, mass(g):{}".format(*args)
    print(string)